...
def inject_login_styles():
    ...
    /* ── Inputs ── */
    [data-testid="column"].login-col-target [data-testid="stTextInput"] > div > div {
        background: rgba(30, 41, 59, 0.6) !important;
        border: 1px solid rgba(255, 255, 255, 0.07) !important;
        border-radius: 12px !important; padding: 4px 10px !important;
        transition: all 0.25s ease !important;
    }
    [data-testid="column"].login-col-target [data-testid="stTextInput"] > div > div:focus-within {
        border-color: rgba(59, 130, 246, 0.6) !important;
        box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.12) !important;
        background: rgba(30, 41, 59, 0.85) !important;
    }
    [data-testid="column"].login-col-target [data-testid="stTextInput"] input { color: #e2e8f0 !important; font-family: 'Inter', sans-serif !important; font-size: 0.95rem !important; }
    [data-testid="column"].login-col-target [data-testid="stTextInput"] label { color: rgba(148, 163, 184, 0.85) !important; font-weight: 600 !important; font-size: 0.75rem !important; text-transform: uppercase !important; letter-spacing: 0.1em !important; }

    /* ── Button ── */
    [data-testid="column"].login-col-target .stButton > button {
    ...
    [data-testid="column"].login-col-target .stButton > button:hover {
    ...
    /* ── Error ── */
    [data-testid="column"].login-col-target [data-testid="stAlert"] {
...
def render_login_page():
    ...
    with login_col:
        ...
        submitted = st.button("🔓  ACCÉDER AU TERMINAL", use_container_width=True, key="login_btn")
